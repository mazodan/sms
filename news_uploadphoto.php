...
<h1 class="page-header">Upload News Photo</h1>
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			...
			<form method="post" action="<?= base_url() ?>news_uploadphoto_proc.php?id=<?= $id ?>" enctype="multipart/form-data">
			<p style="margin-top:24px;">
			  ...
			  <fieldset>
				...
				<div class="form-actions">
				  ...
				  <a href="news_edit.php?id=<?= $id ?>" value="Cancel" class="btn">Cancel</a>
				</div>
			  </fieldset>
			</form>   
		</div>

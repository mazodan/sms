...
//        $target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]);
        ...
        if ($uploadOk == 0) {
            ...
            header("Location: news_uploadphoto.php?id=".$id);
        // if everything is ok, try to upload file
            ...
            <div class="alert alert-success">
                ...
                $table_name = "news";
                $page_picture = basename($_FILES["fileToUpload"]["name"]);

                $user_editedvalues = array (
                    //columname from table => value from post
                        "page_picture" => $photo_name
                );
            ...
            <p>
                <a href="<?= base_url() ?>news_manage.php">
                    <button type="button" class="btn btn-primary">
                    Return to Manage News' Page</button>
                </a>
            </p>
            <?php
            } else {
                ...
                $text = "Admin $whoami has successfully uploaded a picture ";
